...
import com.rumahproduksi.obugame.adapter.BahanLainnyaAdapter
import com.rumahproduksi.obugame.adapter.dataclass_model.BahanLainnyaModel
import com.rumahproduksi.obugame.databinding.FragmentBahanLainnyaBinding


class BahanLainnyaFragment : Fragment() {
    lateinit var binding: FragmentBahanLainnyaBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBahanLainnyaBinding.inflate(inflater, container, false)
        list = ArrayList()
        ...
        val adapter = context?.let { BahanLainnyaAdapter(it, list) }

        database.reference.child("bahan_lainnya")
        ...
        mDbRef = FirebaseDatabase.getInstance().reference.child("bahan_lainnya")
