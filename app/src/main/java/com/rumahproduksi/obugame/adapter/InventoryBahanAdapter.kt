...
class InventoryBahanAdapter(private val context: Context?, private val list: ArrayList<InventoriModel>, private val activeID: String )
    :RecyclerView.Adapter<InventoryBahanAdapter.DetailViewHolder>() {
    ...
    private fun deleteItem(position: Int) {
        if (position < list.size) {
            ...
            val databaseReference = FirebaseDatabase.getInstance().getReference("bahan_lainnya").child(activeID).child("inventori")
