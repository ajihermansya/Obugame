...
class InventoryAdapter(private val context: Context?, private val list: ArrayList<InventoriModel>, private val activeID: String )
    ...
    private fun deleteItem(position: Int) {
        if (position < list.size) {
            ...
            val databaseReference = FirebaseDatabase.getInstance().getReference("bahan_baku").child(activeID).child("inventori")
