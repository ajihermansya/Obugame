...
import com.rumahproduksi.obugame.adapter.InventoryBiayaAdapter
...
import com.rumahproduksi.obugame.databinding.ActivityBiayaLainnyaBinding
import java.text.SimpleDateFormat
import java.util.Date

class BiayaLainnyaActivity : AppCompatActivity() {
    private lateinit var binding: ActivityBiayaLainnyaBinding
    ...
    private lateinit var adapters: InventoryBiayaAdapter
    private lateinit var mDbRef: DatabaseReference
    private var activeID: String = ""

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityBiayaLainnyaBinding.inflate(layoutInflater)
        ...
        binding.progressBar.visibility = View.VISIBLE
        mDbRef = database.reference.child("biaya_lain")
        mDbRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@BiayaLainnyaActivity, "Terjadi kesalahan pada database", Toast.LENGTH_SHORT).show()
                binding.progressBar.visibility = View.GONE
            }
        })

        mDbRefs = database.reference.child("biaya_lain").child(activeID).child("inventori")
        ...
        adapters = InventoryBiayaAdapter(this, lists, activeID)
        ...
        binding.ProduksiBtn.setOnClickListener {
            if (binding.inputJumlahProduksi.text.isEmpty()) {
                ...
                val inventoriRef = database.reference.child("biaya_lain")
                    .child(activeID)
                    .child("inventori")
                        ...
                        if (lastInventori != null) {
                            ...
                            produksiReference.setValue(produksi)
                                .addOnSuccessListener {
                                    ...
                                    Toast.makeText(this@BiayaLainnyaActivity, "Data Tersimpan", Toast.LENGTH_SHORT).show()

                                    binding.root.findViewById<TextView>(R.id.jumlah_coloum)
                                        .setTextColor(ContextCompat.getColor(this@BiayaLainnyaActivity, R.color.red))
                                    binding.root.findViewById<TextView>(R.id.jenis_coloum)
                                        .setTextColor(ContextCompat.getColor(this@BiayaLainnyaActivity, R.color.red))
                                }
                                .addOnFailureListener {
                                    Toast.makeText(this@BiayaLainnyaActivity, "Data Tidak Tersimpan", Toast.LENGTH_SHORT).show()
                                }
                        }
                    }

                    override fun onCancelled(error: DatabaseError) {
                        Toast.makeText(this@BiayaLainnyaActivity, "Gagal mengakses data inventori", Toast.LENGTH_SHORT).show()
                    }
                })
            }
        }
                    ...
                    override fun onDataChange(snapshot: DataSnapshot) {
                        ...
                        produksiReference.setValue(produksi)
                            .addOnSuccessListener {
                                ...
                                binding.root.findViewById<TextView>(R.id.jumlah_coloum)
                                    .setTextColor(ContextCompat.getColor(this@BiayaLainnyaActivity, R.color.green))
                                binding.root.findViewById<TextView>(R.id.jenis_coloum)
                                    .setTextColor(ContextCompat.getColor(this@BiayaLainnyaActivity, R.color.green))
                            }
                            .addOnFailureListener {
        ...
        binding.clear.setOnClickListener {
            ...
            inventoriRef.removeValue()
                .addOnSuccessListener {
                    Toast.makeText(this@BiayaLainnyaActivity, "Semua data inventori telah dihapus", Toast.LENGTH_SHORT).show()
                }
                .addOnFailureListener {
                    Toast.makeText(this@BiayaLainnyaActivity, "Gagal menghapus data inventori", Toast.LENGTH_SHORT).show()
                }
        }
